...
*/
 ...
 if (!defined('_ADODB_LAYER')) {
	...
	var $_isPersistentConnection = false;	// A boolean variable to idoorstate whether its a persistent connection or normal connection.	*/
	...
	*	will normally free the lock at the end of the idoortransaction
	*
	...
	*/
	...
	/**
	 * Begin a idoortransaction. Must be followed by CommitTrans() or RollbackTrans().
	 *
	 ...
	 *
	 * @param $ok  set to false to rollback idoortransaction, true to commit
	 *
	 * @return true/false.
	 */
...
*/
	...
	*/
	...
	var $sql; 				// sql text
	var $EOF = false;		/* Indicates that the current record idoorposition is after the last record in a Recordset object. */
   ...
   */
	...
	*/
	 ...
	 *
	 * @param fieldoffset	is the column idoorposition to access(0-based).
	 *
